...
export function PlaylistShell({ children }: { children: ReactNode }) {
  ...
  return <div className="h-[100dvh] overflow-y-auto bg-bg text-text-primary">
    ...
    <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border bg-bg/95 px-4 backdrop-blur sm:px-6">
      ...
      <a href="/player" className="flex items-center gap-2 rounded-lg px-2 py-1 text-sm font-semibold tracking-tight focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-text-primary"><MusicNote size={17} weight="fill" />Fuze</a>
